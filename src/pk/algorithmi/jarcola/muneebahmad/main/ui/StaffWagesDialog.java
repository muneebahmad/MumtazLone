 ...
 * @author muneebahmad
 */
public class StaffWagesDialog {

    private final ImageView logo = new ImageView(new Image(AboutDialog.class.getResourceAsStream("gfx/algo_logo3.png")));
    private static final String TITLE = "Staff Dialog";
    private static final String LBLTXT = "The list displayed represent your staff/worker(s)."
            + " you can add more or delete already added at any time.";
     ...
     * @return
     */
    public static StaffWagesDialog make() {
        return new StaffWagesDialog();
    }
    ...
    private void addNewItemsDialog() {
        ...
        Text nameTxt = new Text(30, 30, "Enter name of Staff/Employee!");
        nameTxt.setFont(fnt);
        ...
        Text priceTxt = new Text(30, 90, "Enter wage(s) of Employee");
        ...
        priceField.setPromptText("Wage(s) of Employee");
        ...
        saveButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            @Override
            public void handle(ActionEvent t) {
                StaffWagesPersistence.addStaff(nameField.getText().toUpperCase(), priceField.getText());
